...
def compareAll(lhash, data, total, unit_length, tlen):
	...
	#Task
	#write a code to compare (data) and all entries in (lhash)'s first (tlen/2) bytes
	#return the index of item matched, otherwise return -1
	#hint: use a for-loop until you reach the end of the lhash
	#hint: use the function compare already given to you to compare tlen characters (tlen/2 bytes)
